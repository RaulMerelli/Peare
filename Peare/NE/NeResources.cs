...
namespace Peare
{
    public static class NeResources
    {
        ...
        public static byte[] OpenResourceNE(ModuleResources.ModuleProperties properties, string typeName, string targetResourceName, out string message, out bool found)
        {
