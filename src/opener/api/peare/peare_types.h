...
typedef enum peare_container_format {
    ...
    PEARE_CONTAINER_FAT,
    PEARE_CONTAINER_UDF,
    PEARE_CONTAINER_EXFAT,
    PEARE_CONTAINER_VMDK,
    PEARE_CONTAINER_EXT,
    PEARE_CONTAINER_NTFS,
    PEARE_CONTAINER_VHD,
    PEARE_CONTAINER_VDI,
    PEARE_CONTAINER_VHDX,
    PEARE_CONTAINER_SDI,
    PEARE_CONTAINER_XVA,
    PEARE_CONTAINER_SWAP,
    PEARE_CONTAINER_LVM,
    PEARE_CONTAINER_XFS,
    PEARE_CONTAINER_SQUASHFS,
    PEARE_CONTAINER_HFSPLUS,
    PEARE_CONTAINER_DMG,
    PEARE_CONTAINER_BTRFS,
    PEARE_CONTAINER_REGISTRY,
    PEARE_CONTAINER_BOOTCONFIG,
    PEARE_CONTAINER_CAB,
    PEARE_CONTAINER_RAW_DISK,
    PEARE_CONTAINER_ZIP,
    PEARE_CONTAINER_TAR,
    PEARE_CONTAINER_LINUX_RAID,
    PEARE_CONTAINER_DYNAMIC_DISK,
    PEARE_CONTAINER_WINCE_ROM,
    PEARE_CONTAINER_JFS,
